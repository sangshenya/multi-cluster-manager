...
func GetAggregatePolicyListWithLabelSelector(ctx context.Context, clientSet *multclusterclient.Clientset, ns string, ruleName NamespacedName) (*v1alpha1.ResourceAggregatePolicyList, error) {
